...
export default class Grammar {
  ...
  /**
   * Returns original representation of the lexical grammar.
   */
  getOriginalLex() {
  ...
  /**
   * Returns original representation of the bnf grammar.
   */
  getOriginalBnf() {
   ...
   */
  isToken(symbol) {
    return this.isTerminal(symbol) || this.getLexVars().indexOf(symbol) !== -1;
  }
