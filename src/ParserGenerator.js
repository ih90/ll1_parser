...
import SetsGenerator from "./SetsGenerator.js";
import TablePrinter from "./TablePrinter.js";
import { EPSILON, EOF } from "./constants.js";
...
export default class ParserGenerator {
   ...
   */
  generate() {
    return new Parser(this.getGrammar(), this.getTable());
  }
  ...
  /**
   * Returns the parsing table (builds one if it's not yet built).
   */
  getTable() {
